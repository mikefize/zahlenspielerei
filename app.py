...
def check_password():
    ...
    def password_entered():
        ...
        if st.session_state["password"] == "cube_2025": 
            st.session_state["password_correct"] = True
            del st.session_state["password"]  # Passwort aus Speicherfeld löschen
        else:
            st.session_state["password_correct"] = False

    if "password_correct" not in st.session_state:
        # Erster Start: State initialisieren
        st.session_state["password_correct"] = False

    if not st.session_state["password_correct"]:
        # Noch nicht eingeloggt: Eingabefeld zeigen
        st.header("🔒 Login")
        st.text_input(
...
# ==============================================================================
# HAUPT-ANWENDUNG (WIRD NUR AUSGEFÜHRT, WENN EINGELOGGT)
# ==============================================================================
